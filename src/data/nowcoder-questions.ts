...
Monorepo 通过 workspace 协议依赖内部包（如 pnpm workspace）：
...
**面试话术**："Vue3 Composition API 让逻辑复用更清晰（自定义 hooks）、TypeScript 更友好、性能更好（Proxy + PatchFlag）。**逻辑不再按选项拆散**，能按功能内聚。setup 语法糖进一步简化写法。"
`,
  },
  {
    id: 2114,
